        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="serv-img md-mb50">
              <img src={lightTheme ? "/img/mobile-app/app-img/light/s1.png" : "/img/mobile-app/app-img/s1.png"} alt="" />
            </div>
          </div>
          <div className="col-lg-6 offset-lg-1 valign">
            <div className="content">
              <h6 className="stit mb-30">
                <span className="left"></span> Customize Application
              </h6>
        ...
        <div className="row mt-80">
          ...
          <div className="col-lg-5 offset-lg-1">
            <div className="serv-img">
              <img src={lightTheme ? "/img/mobile-app/app-img/light/s2.png" : "/img/mobile-app/app-img/s2.png"} alt="" />
            </div>
          </div>
        </div>
      </div>
